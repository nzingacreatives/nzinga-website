...
(function(){
  ...
  function boot(){
    load('site-visual-fix.js?v=2');
    if(location.pathname.endsWith('/servicos.html')||location.pathname.endsWith('servicos.html'))load('sales-prices.js?v=2');
    ...
    setTimeout(function(){if(location.pathname.endsWith('/minha-nzinga.html')||location.pathname.endsWith('minha-nzinga.html')){load('minha-nzinga-fix.js?v=2');load('support-user.js?v=1')}},800);
  }
