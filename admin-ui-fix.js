...
(function(){
  ...
  function init(){
    ...
    style.textContent=''
      ...
      +'.admin-shell,.admin-main,.admin-content{min-width:0;max-width:100%;box-sizing:border-box}'
      ...
      +'@media(max-width:900px){'
        ...
        +'#nz-admin-global-nav .nz-links{display:none!important;position:absolute;top:68px;left:0;right:0;width:100%;background:#101010;padding:16px 18px;flex-direction:column;align-items:stretch;border-bottom:2px solid #ededed;box-shadow:0 8px 20px rgba(0,0,0,.35);z-index:100001!important}'
