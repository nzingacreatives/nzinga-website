...
let bootLang=get();
function loadAccessibility(){if(document.querySelector('script[data-nzinga-accessibility]'))return;const s=document.createElement('script');s.src='accessibility-contrast.js?v=4';s.defer=true;s.dataset.nzingaAccessibility='1';document.head.appendChild(s)}
